...
import com.example.clearsolutions.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        List<ObjectError> validadtionErrorList = ex.getBindingResult().getAllErrors();

        validadtionErrorList.forEach(err -> {
    ...
    public ResponseEntity<ErrorResponseDto> handleUserNotAdultException(UserNotAdultException exception,
                                                               WebRequest webRequest) {
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(
                webRequest.getDescription(false),
                HttpStatus.BAD_REQUEST,
